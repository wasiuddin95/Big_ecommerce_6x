	...
	$("#current_pwd").keyup(function(){
		...
		$.ajax({
			...
			success:function(resp){
				// alert(resp);
				if(resp=="false"){
					$("#chkPwd").html("<font color='red'>Current Password in Incorrect!!</font>");
				}else if(resp=="true"){
					$("#chkPwd").html("<font color='green'>Current Password in Correct!!</font>");
				}
			}
			,error:function(){
				alert("Error");

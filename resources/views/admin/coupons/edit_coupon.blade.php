            ...
            <div class="widget-content nopadding">
              ...
              name="add_coupon" id="add_coupon" >
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    <select name="amount_type" id="amount_type" class="select2" style="width: 220px;" required>
                      <option @if($couponDetails->amount_type=="Percentage") selected @endif value="Percentage">
                        Percentage</option>
                      <option @if($couponDetails->amount_type=="Fixed") selected @endif value="Fixed">
                          Fixed</option>
                    </select>
                  </div>
                </div>

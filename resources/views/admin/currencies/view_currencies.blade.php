            ...
            <table class="table table-bordered data-table">
              <thead>
                <tr>
                  ...
                  <th style="text-align: left;">Update at</th>
              ...
              <tr class="gradeX">
                ...
                <td>{{ $currency->exchange_rate }}/Tk</td>
                <td>{{ $currency->updated_at }}</td>
                <td>
                    @if($currency->status=="1") Active @else Inactive @endif
                </td>
                <td class="center"><a href="{{ url('/admin/edit-currency/'.$currency->id) }}" class="btn btn-primary btn-mini">Edit </a> 
                  <a href="javascript:" rel="{{ $currency->id }}" rel1="delete-currency" 

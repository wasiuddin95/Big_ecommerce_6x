          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              <tr class="gradeX">
                ...
                <td class="center">
                  <a href="{{ url('/admin/view-order/'.$order->id) }}" target="_blank" 
                    style="margin-bottom: 5px;" class="btn btn-success btn-mini">View Order Details</a> <br>
                  @if ($order->order_status == "Shipped" || $order->order_status == "Delivered" 
                      || $order->order_status == "Paid" )
                    <a href="{{ url('/admin/view-order-invoice/'.$order->id) }}" target="_blank"
                      style="margin-bottom: 5px;" class="btn btn-info btn-mini">View Order Invoice</a> <br>

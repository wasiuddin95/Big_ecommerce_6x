...
<div id="content">
    <div id="content-header">
      <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i>
         Home</a> <a href="#">CMS Pages</a> <a href="#" class="current">Edit CMS Page</a> </div>
      <h1>CMS Pages</h1>
        ...
        <div class="span12">
          <div class="widget-box">
            ...
            <div class="widget-content nopadding">
              ...
              name="edit_cms_page" id="edit_cms_page" enctype="multipart/form-data">
                @csrf
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    ...
                    class="textarea_editor span8">{{ $cmsPage->description }}</textarea>
                  </div>
                </div>
                <div class="control-group">

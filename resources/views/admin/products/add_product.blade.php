        ...
        <div class="span12">
          <div class="widget-box">
            ...
            <div class="widget-content nopadding">
              ...
              name="add_product" id="add_product" novalidate="novalidate" enctype="multipart/form-data">
                @csrf
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    <textarea name="care" id="care" class="textarea_editor2 span8"></textarea>
                  </div>
                </div>
                <div class="control-group">
                ...
                <div class="control-group">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="text" name="weight" id="weight" placeholder="Ex: 100 gram">
                    </div>
                  </div>
                  <div class="control-group">

        ...
        <div class="span12">
          <div class="widget-box">
            ...
            <div class="widget-content nopadding">
              ...
              name="edit_product" id="edit_product" novalidate="novalidate" enctype="multipart/form-data">
                @csrf
                <div class="control-group">
                  <label class="control-label">Under Category</label>
                  <div class="controls">
                    <select name="category_id" id="category_id" class="select2" style="width: 220px;">
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    <textarea name="description" id="description" class="textarea_editor span8">
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    <textarea name="care" id="care" class="textarea_editor2 span8">
                      {{$productDetails->care}}</textarea>
                  </div>
                </div>
                  <div class="control-group">
                  ...
                  <div class="control-group">
                    <label class="control-label">Product Weight (gram)</label>
                    <div class="controls">
                  ...
                  <div class="control-group">
                    <label class="control-label" style="padding-top: 35px;">Image</label>
                    <div class="controls">
                      ...
                      style="width: 70px;"> | <a href="{{ url('/admin/delete-product-image/'.$productDetails->id) }}">
                      Delete</a>
                      @endif
                    </div>
                  </div>
                  <div class="control-group">
                    ...
                    <div class="controls">
                      ...
                      @endif
                      @if (!empty($productDetails->video))
                      {{-- <video src="{{ asset('videos/'.$productDetails->video) }}" style="width: 70px;"></video> --}}
                      <span>{{ $productDetails->video }}</span> | 
                      <a target="_blank" href="{{ asset('videos/'.$productDetails->video) }}">View</a> | 
                      <a href="{{ url('/admin/delete-product-video/'.$productDetails->id) }}">Delete Video</a>
                      @endif
                    </div>
                  </div>
                  <div class="control-group">

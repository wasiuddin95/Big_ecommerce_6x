        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-3 col-sm-offset-1">
                    <div class="single-widget">
                        <h2>Subscribe Our Website <br> To get Special Offers</h2>
                        <form action="javascript:void(0);" class="searchform" method="post">
                            ...
                            <button onclick="checkSubscriber(); addSubscriber();" id="btnSubmit" type="submit" class="btn btn-default">
                                <i class="fa fa-arrow-circle-o-right"></i></button>
                            <div id="statusSubscribe" style="display: none; margin-top: 10px;"></div>
        ...
        $.ajax({
            ...
            success:function(resp){
                if (resp=="exists") {
                    ...
                    $("#statusSubscribe").show();
                    $("#btnSubmit").hide();
                    $("#statusSubscribe").html("<span style='color:red;'>Error: Subscriber email already exists</span>");
                }else if (resp=="Saved") {
                    $("#statusSubscribe").show();
                    $("#statusSubscribe").html("<span style='color:lightseagreen;'>Success: Thanks for Subscribed our Website!!</span>");
                }

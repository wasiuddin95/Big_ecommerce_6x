					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								...
								<li><a href="#"><i class="fa fa-envelope"></i> great_ecomm@webmithun.ml</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								...
								') }}"><i class="fa fa-crosshairs"></i> Orders</a></li>
								<li><a href="{{ url('/cart') }}"><i class="fa fa-shopping-cart"></i> 
									Cart <span style="color:red;">({{ $cartCount }})</span></a></li>
								@if(empty(Auth::check()))
					...
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								{{-- Main Categories Product List Start
								<li class="dropdown"><a href="#">Category<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
										@foreach ($mainCategories as $maincat)
										@if($maincat->status=="1")
										<li><a href="{{ asset('products/main/'.$maincat->url) }}">{{ $maincat->name }}</a></li>
										@endif
										@endforeach
                                    </ul>
                                </li> 
								Main Categories Product List End --}} 
					...
					<div class="col-sm-3">
						<div class="search_box pull-right">
						  <form action="{{ url('/search-products') }}" method="GET">
							...
							<button type="submit" class="check_out" style="margin-left: 2px;">Search</button>
						  </form>
						</div>
					</div>
				</div>

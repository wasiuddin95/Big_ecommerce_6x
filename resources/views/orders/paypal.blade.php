    ...
    <div class="container">
        <div class="heading" align="center">
            ...
            <p>Your order number is {{ Session::get('order_id') }} 
                and total payable about is {{ Session::get('grand_total') }}/Tk.</p>
            ...
            <form action="https://www.paypal.com/cgi-bin/webscr" method="POST">
                ...
                {{-- Here My Business Account are set in Value || amitphpprogrammer-facilitator@gmail.com --}}
                {{-- <input type="hidden" name="business" value="amit1000@yopmail.com"> --}}

                    ...
                    <tr>
                        <td class="cart_product">
                            <a href="">
                                ...
                                src="{{ asset('images/backend_images/products/small/'.$cart->image) }}" alt="">
                            </a>
                        </td>
                        ...
                        <td class="cart_total">
                            <p class="cart_total_price">{{ $product_price*$cart->quantity }}/Tk</p>
                        </td>
                    </tr>
        ...
        <form action="{{ url('/place-order') }}" name="paymentForm" id="paymentForm" method="POST">
            ...
            <div class="payment-options">
                ...
                <span style="float: right;">
                    <button type="submit" class="btn btn-info check_out"
                    onclick="return selectPaymentMethod();">Place Order</button>
                </span>
            </div>
        </form>
    </div>
